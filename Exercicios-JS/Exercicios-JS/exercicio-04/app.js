...
*/
const my3FavoriteTVShows = ["Prizon Break", "Wandinha", "Lucifer"];
...
console.log(`A string que a "typeSentence" armazena tem mais de ${numberToCheck} caracteres
  caracteres? ${String(typeSentence.length > numberToCheck).replace(
    "t",
    "T"
  )}`);

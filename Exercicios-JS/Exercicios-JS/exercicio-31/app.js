...
const logGithubUser = async () => {
  const userData = await getUser("agostinhomarcia");
...
const divisors = numbers.filter((num) => num % 2 === 0 || num % 3 === 0);
...
/*
  ...
  - Exemplos de nomes na "língua do 'P'":
    ...
    - Rafaela => "PRaPfaPePla".
*/
const arrayName = ["M", "a", "r", "c", "i", "a"];
const name = arrayName.join("P");
console.log(name);
/*
  04
...
*/
const myName = "Marcia";
const myNameString = myName.split("");

for (let i = 0; i < myName.length; i++) {
  console.log(`${myNameString[i]} é a ${i + 1}ª letra do meu nome.'`);
}
...
console.log(countOccurrences(scores, 100)); // retorna 3
console.log(countOccurrences(scores, 90)); // retorna 2
console.log(countOccurrences(scores, 85)); // retorna 2
console.log(countOccurrences(scores, 60)); // retorna 2
